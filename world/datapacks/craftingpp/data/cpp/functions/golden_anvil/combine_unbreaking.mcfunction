...
execute positioned ~ 255 ~ as @e[type=item,distance=..1,nbt={Item:{tag:{Enchantments:[{id:"minecraft:unbreaking"}]}}}] run function cpp:golden_anvil/combine_unbreaking_loop
