...
execute as @s[scores={cppMacType=1}] run replaceitem block ~ ~ ~ container.21 minecraft:potion{display:{Name:"{\"translate\":\"item.cpp.potion.cold_drink\"}"},CustomPotionEffects:[{Id:23b,Amplifier:3b}]}
execute as @s[scores={cppMacType=2..4}] run replaceitem block ~ ~ ~ container.21 minecraft:ice
execute as @s[scores={cppMacType=2..4}] run replaceitem block ~ ~ ~ container.22 minecraft:potion{HideFlags:31,CustomPotionColor:10551200,display:{Name:"{\"translate\":\"item.cpp.ammonia_refrigerant\"}"},id:"cpp:ammonia_refrigerant",CustomPotionEffects:[{Id:19b,Amplifier:0b,Duration:300s}]}
