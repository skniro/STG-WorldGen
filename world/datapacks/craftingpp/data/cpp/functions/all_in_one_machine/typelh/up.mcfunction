...
execute as @s[scores={cppMacType=1}] run replaceitem block ~ ~1 ~ container.0 minecraft:potion{display:{Name:"{\"translate\":\"item.cpp.potion.cold_drink\"}"},CustomPotionEffects:[{Id:23b,Amplifier:3b}]}
execute as @s[scores={cppMacType=2..4}] run replaceitem block ~ ~1 ~ container.0 minecraft:ice
execute as @s[scores={cppMacType=2..4}] run replaceitem block ~ ~1 ~ container.1 minecraft:potion{HideFlags:31,CustomPotionColor:10551200,display:{Name:"{\"translate\":\"item.cpp.ammonia_refrigerant\"}"},id:"cpp:ammonia_refrigerant",CustomPotionEffects:[{Id:19b,Amplifier:0b,Duration:300s}]}
