...
execute as @s[scores={cppSlotsDown=0..25}] run function cpp:all_in_one_machine/typeln/south
execute as @s[scores={cppSlotsDown=26..}] run function cpp:all_in_one_machine/typeln/self
