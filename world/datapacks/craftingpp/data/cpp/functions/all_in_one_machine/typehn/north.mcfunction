...
function cpp:random
execute as @s[scores={cppRandom=1}] run replaceitem block ~ ~ ~-1 container.1 minecraft:charcoal{HideFlags:63,id:"cpp:cinder",display:{Name:"{\"cppMacType=1..9,cppRandom\":\"item.cpp.cinder\"}"},Enchantments:[{}]}
