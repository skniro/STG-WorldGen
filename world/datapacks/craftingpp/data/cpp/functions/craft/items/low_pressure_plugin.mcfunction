replaceitem block ~ ~ ~ container.16 minecraft:wooden_sword{Damage:13,Unbreakable:1b,HideFlags:63,display:{Name:"{\"translate\":\"item.cpp.low_pressure_plugin\"}"},id:"cpp:low_pressure_plugin",MachinePlugin:1b}
