replaceitem block ~ ~ ~ container.16 minecraft:wooden_sword{display:{Name:"{\"translate\":\"item.cpp.industrious_hand\"}"},HideFlags:63,id:"cpp:industrious_hand",Unbreakable:1b,Damage:26}
