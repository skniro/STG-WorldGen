replaceitem block ~ ~ ~ container.16 minecraft:wooden_sword{display:{Name:"{\"translate\":\"item.cpp.break_hand\"}"},HideFlags:63,id:"cpp:break_hand",Unbreakable:1b,Damage:27}
