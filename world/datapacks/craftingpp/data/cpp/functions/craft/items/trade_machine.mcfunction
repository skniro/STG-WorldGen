replaceitem block ~ ~ ~ container.16 minecraft:carrot_on_a_stick{display:{Name:"{\"translate\":\"item.cpp.trade_machine\"}"},HideFlags:63,id:"cpp:trade_machine",Unbreakable:1b,Damage:21}
