replaceitem block ~ ~ ~ container.16 minecraft:carrot_on_a_stick{Damage:1,HideFlags:63,Unbreakable:1b,display:{Name:"{\"translate\":\"item.cpp.blue_force_of_sky\"}"},id:"cpp:blue_force_of_sky"}
