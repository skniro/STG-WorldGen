replaceitem block ~ ~ ~ container.16 minecraft:wooden_sword{Damage:12,Unbreakable:1b,HideFlags:63,display:{Name:"{\"translate\":\"item.cpp.empty_plugin\"}"},id:"cpp:empty_plugin"}
