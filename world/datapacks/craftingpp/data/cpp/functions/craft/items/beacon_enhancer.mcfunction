replaceitem block ~ ~ ~ container.16 minecraft:stone_sword{display:{Name:"{\"translate\":\"item.cpp.beacon_enhancer\"}"},HideFlags:63,id:"cpp:beacon_enhancer",Unbreakable:1b,Damage:129}
