replaceitem block ~ ~ ~ container.16 minecraft:carrot_on_a_stick{Damage:3,HideFlags:63,Unbreakable:1b,display:{Name:"{\"translate\":\"item.cpp.cyan_force_of_mountain\"}"},id:"cpp:cyan_force_of_mountain"}
