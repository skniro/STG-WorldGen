replaceitem block ~ ~ ~ container.16 minecraft:carrot_on_a_stick{Damage:4,HideFlags:63,Unbreakable:1b,display:{Name:"{\"translate\":\"item.cpp.orange_force_of_dirt\"}"},id:"cpp:orange_force_of_dirt"}
