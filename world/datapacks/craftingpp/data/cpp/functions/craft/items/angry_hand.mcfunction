replaceitem block ~ ~ ~ container.16 minecraft:wooden_sword{display:{Name:"{\"translate\":\"item.cpp.angry_hand\"}"},HideFlags:63,id:"cpp:angry_hand",Unbreakable:1b,Damage:29}
