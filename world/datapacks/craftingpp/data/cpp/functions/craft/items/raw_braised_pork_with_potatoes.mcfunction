replaceitem block ~ ~ ~ container.16 minecraft:rabbit_stew{display:{Name:"{\"translate\":\"item.cpp.raw_braised_pork_with_potatoes\"}"},id:"cpp:raw_braised_pork_with_potatoes"}
