replaceitem block ~ ~ ~ container.16 minecraft:carrot_on_a_stick{Damage:17,Unbreakable:1b,HideFlags:63,display:{Name:"{\"translate\":\"item.cpp.coordinate_recorder\"}"},id:"cpp:coordinate_recorder",StoredCoordinate:{X:0,Y:0,Z:0},hasRecord:0b}
