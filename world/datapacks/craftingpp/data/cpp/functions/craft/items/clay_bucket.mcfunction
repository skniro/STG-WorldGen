replaceitem block ~ ~ ~ container.16 minecraft:wooden_sword{Damage:10,Unbreakable:1b,HideFlags:63,display:{Name:"{\"translate\":\"item.cpp.clay_bucket\"}"},id:"cpp:clay_bucket"}
