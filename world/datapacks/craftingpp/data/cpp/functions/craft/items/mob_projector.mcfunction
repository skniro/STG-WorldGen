replaceitem block ~ ~ ~ container.16 minecraft:carrot_on_a_stick{display:{Name:"{\"translate\":\"item.cpp.mob_projector\"}"},HideFlags:63,id:"cpp:mob_projector",Unbreakable:1b,Damage:23}
