replaceitem block ~ ~ ~ container.16 minecraft:wooden_sword{Damage:23,Unbreakable:1b,HideFlags:63,id:"cpp:dream_wand",Enchantments:[{}],display:{Name:"{\"translate\":\"item.cpp.dream_wand\"}"}}
