replaceitem block ~ ~ ~ container.16 minecraft:apple{HideFlags:63,Enchantments:[{}],display:{Name:"{\"translate\":\"item.cpp.toffee_apple\"}",Lore:["§r§9速度 (0:30)"]},id:"cpp:toffee_apple"}
