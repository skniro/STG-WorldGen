replaceitem block ~ ~ ~ container.16 minecraft:wooden_sword{Damage:17,Unbreakable:1b,HideFlags:63,display:{Name:"{\"translate\":\"item.cpp.cobblestone_plugin\"}"},id:"cpp:cobblestone_plugin"}
