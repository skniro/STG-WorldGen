replaceitem block ~ ~ ~ container.16 minecraft:carrot_on_a_stick{Damage:9,HideFlags:63,Unbreakable:1b,display:{Name:"{\"translate\":\"item.cpp.black_force_of_moon\"}"},id:"cpp:black_force_of_moon"}
