replaceitem block ~ ~ ~ container.16 minecraft:carrot_on_a_stick{Damage:8,HideFlags:63,Unbreakable:1b,display:{Name:"{\"translate\":\"item.cpp.white_force_of_lightning\"}"},id:"cpp:white_force_of_lightning"}
