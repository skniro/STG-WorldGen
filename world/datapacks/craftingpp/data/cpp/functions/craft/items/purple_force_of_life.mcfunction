replaceitem block ~ ~ ~ container.16 minecraft:carrot_on_a_stick{Damage:7,HideFlags:63,Unbreakable:1b,display:{Name:"{\"translate\":\"item.cpp.purple_force_of_life\"}"},id:"cpp:purple_force_of_life"}
