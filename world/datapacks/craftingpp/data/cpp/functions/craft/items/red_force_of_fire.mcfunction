replaceitem block ~ ~ ~ container.16 minecraft:carrot_on_a_stick{Damage:6,HideFlags:63,Unbreakable:1b,display:{Name:"{\"translate\":\"item.cpp.red_force_of_fire\"}"},id:"cpp:red_force_of_fire"}
