replaceitem block ~ ~ ~ container.16 minecraft:elytra{Damage:1,HideFlags:63,Unbreakable:1b,display:{Name:"{\"translate\":\"item.cpp.shooting_star\"}"},id:"cpp:shooting_star"}
