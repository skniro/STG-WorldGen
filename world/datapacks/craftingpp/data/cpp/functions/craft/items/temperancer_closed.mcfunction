replaceitem block ~ ~ ~ container.16 minecraft:carrot_on_a_stick{Damage:16,Unbreakable:1b,HideFlags:63,id:"cpp:temperancer_closed",display:{Name:"{\"translate\":\"item.cpp.temperancer_closed\"}"}}
