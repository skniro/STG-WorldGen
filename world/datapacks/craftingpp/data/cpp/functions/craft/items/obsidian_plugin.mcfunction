replaceitem block ~ ~ ~ container.16 minecraft:wooden_sword{Damage:19,Unbreakable:1b,HideFlags:63,display:{Name:"{\"translate\":\"item.cpp.obsidian_plugin\"}"},id:"cpp:obsidian_plugin"}
