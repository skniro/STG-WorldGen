replaceitem block ~ ~ ~ container.16 minecraft:wooden_sword{Damage:22,Unbreakable:1b,HideFlags:63,id:"cpp:star_wand",Enchantments:[{}],display:{Name:"{\"translate\":\"item.cpp.star_wand\"}"}}
