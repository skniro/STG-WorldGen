replaceitem block ~ ~ ~ container.16 minecraft:carrot_on_a_stick{Damage:13,Unbreakable:1b,HideFlags:63,display:{Name:"{\"translate\":\"item.cpp.compressor\"}"},id:"cpp:compressor"}
