replaceitem block ~ ~ ~ container.16 minecraft:carrot_on_a_stick{Damage:11,Unbreakable:1b,HideFlags:63,display:{Name:"{\"translate\":\"item.cpp.time_conditioner\"}"},Enchantments:[{}],id:"cpp:time_conditioner"}
