replaceitem block ~ ~ ~ container.16 minecraft:potion{HideFlags:31,CustomPotionColor:43520,display:{Name:"{\"translate\":\"item.cpp.acid\"}"},id:"cpp:acid",CustomPotionEffects:[{Id:9b,Amplifier:0b,Duration:100s}]}
