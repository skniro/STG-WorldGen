replaceitem block ~ ~ ~ container.16 minecraft:leather_leggings{display:{Name:"{\"translate\":\"item.cpp.tight_leather_leggings\"}",color:460551},id:"cpp:tight_leather_leggings"}
