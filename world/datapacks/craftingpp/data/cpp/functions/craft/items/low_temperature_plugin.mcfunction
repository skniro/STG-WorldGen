replaceitem block ~ ~ ~ container.16 minecraft:wooden_sword{Damage:15,Unbreakable:1b,HideFlags:63,display:{Name:"{\"translate\":\"item.cpp.low_temperature_plugin\"}"},id:"cpp:low_temperature_plugin",MachinePlugin:1b}
