replaceitem block ~ ~ ~ container.16 minecraft:carrot_on_a_stick{Damage:2,HideFlags:63,Unbreakable:1b,display:{Name:"{\"translate\":\"item.cpp.green_force_of_water\"}"},id:"cpp:green_force_of_water"}
