replaceitem block ~ ~ ~ container.16 minecraft:carrot_on_a_stick{Damage:18,HideFlags:63,Unbreakable:1b,display:{Name:"{\"translate\":\"item.cpp.golem_fisher\"}"},id:"cpp:golem",GolemType:"fisher"}
