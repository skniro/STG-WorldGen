replaceitem block ~ ~ ~ container.16 minecraft:wooden_sword{display:{Name:"{\"translate\":\"item.cpp.smart_hand\"}"},HideFlags:63,id:"cpp:smart_hand",Unbreakable:1b,Damage:28}
