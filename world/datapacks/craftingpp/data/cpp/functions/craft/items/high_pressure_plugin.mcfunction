replaceitem block ~ ~ ~ container.16 minecraft:wooden_sword{Damage:14,Unbreakable:1b,HideFlags:63,display:{Name:"{\"translate\":\"item.cpp.high_pressure_plugin\"}"},id:"cpp:high_pressure_plugin",MachinePlugin:1b}
