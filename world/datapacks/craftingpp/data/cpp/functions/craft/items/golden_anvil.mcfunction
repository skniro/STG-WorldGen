replaceitem block ~ ~ ~ container.16 minecraft:carrot_on_a_stick{display:{Name:"{\"translate\":\"item.cpp.golden_anvil\"}"},HideFlags:63,id:"cpp:golden_anvil",Unbreakable:1b,Damage:24}
