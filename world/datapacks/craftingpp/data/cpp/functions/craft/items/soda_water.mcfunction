replaceitem block ~ ~ ~ container.16 minecraft:potion{HideFlags:31,CustomPotionColor:1839758,display:{Name:"{\"translate\":\"item.cpp.soda_water\"}"},id:"cpp:soda_water",CustomPotionEffects:[{Id:9b,Amplifier:0b,Duration:100s}]}
