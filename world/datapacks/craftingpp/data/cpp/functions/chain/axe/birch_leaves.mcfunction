...
execute as @s[scores={cppChainEnch=0..,cppRandom=1}] run summon item ~ ~ ~ {Item:{id:"minecraft:birch_sapling",Count:1b}}
execute as @s[scores={cppChainEnch=-1}] run summon item ~ ~ ~ {Item:{id:"minecraft:birch_leaves",Count:1b}}
setblock ~ ~ ~ air
