execute as @s[scores={cppUseAxe1=1..}] run scoreboard players set #max_durality cppValue 1562
execute as @s[scores={cppUseAxe2=1..}] run scoreboard players set #max_durality cppValue 251
execute as @s[scores={cppUseAxe3=1..}] run scoreboard players set #max_durality cppValue 33
execute as @s[scores={cppUseAxe4=1..}] run scoreboard players set #max_durality cppValue 132
...
execute at @e[type=item,distance=..6,nbt={Age:0s},sort=nearest,limit=1] align xyz run function cpp:chain/axe_mark
execute at @e[type=item,distance=..6,nbt={Age:1s},sort=nearest,limit=1] align xyz run function cpp:chain/axe_mark
execute if score #temp cppValue > #max_durality cppValue run replaceitem entity @s weapon.mainhand air

execute at @e[tag=cpp_axe_damage] run function cpp:chain/axe_break
kill @e[type=area_effect_cloud,tag=cpp_axe_damage]
