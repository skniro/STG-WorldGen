execute store result score #playerPos cppValue run data get entity @p[nbt={Inventory:[{tag:{id:"cpp:magnet",Type:2b}}]}] Pos[0] 100
...
execute store result score #playerPos cppValue run data get entity @p[nbt={Inventory:[{tag:{id:"cpp:magnet",Type:2b}}]}] Pos[1] 100
...
execute store result score #playerPos cppValue run data get entity @p[nbt={Inventory:[{tag:{id:"cpp:magnet",Type:2b}}]}] Pos[2] 100
