...
execute as @s[scores={cppValue=90..179}] if block ~-1 ~ ~ iron_bars run execute align xyz run summon armor_stand ~-0.5 ~0.5 ~0.5 {Invulnerable:1b,Invisible:1b,NoGravity:1b,Marker:1b,Small:1b,DisabledSlots:7967,Tags:["vertical_slabs","stone_brick_slab"],HandItems:[{id:"minecraft:stone_brick_slab",Count:1b},{}],Pose:{RightArm:[0.0f,90.0f,0.0f]}}
execute as @s[scores={cppValue=180..269}] if block ~ ~ ~-1 iron_bars run execute align xyz run summon armor_stand ~0.65625 ~0.5 ~-0.34375 {Invulnerable:1b,Invisible:1b,NoGravity:1b,Marker:1b,Small:1b,DisabledSlots:7967,Tags:["vertical_slabs","stone_brick_slab"],HandItems:[{id:"minecraft:stone_brick_slab",Count:1b},{}],Pose:{RightArm:[0.0f,0.0f,0.0f]}}
