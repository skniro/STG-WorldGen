...
execute if score #temp cppValue matches 0..89 at @e[tag=cpp_front_air,limit=1] align xyz run setblock ~ ~ ~ minecraft:chest[facing=south]{CustomName:"{\"translate\":\"item.cpp.trade_machine\"}"}
execute if score #temp cppValue matches 90..180 at @e[tag=cpp_front_air,limit=1] align xyz run setblock ~ ~ ~ minecraft:chest[facing=west]{CustomName:"{\"translate\":\"item.cpp.trade_machine\"}"}
execute if score #temp cppValue matches 180..270 at @e[tag=cpp_front_air,limit=1] align xyz run setblock ~ ~ ~ minecraft:chest[facing=north]{CustomName:"{\"translate\":\"item.cpp.trade_machine\"}"}
execute if score #temp cppValue matches 270..360 at @e[tag=cpp_front_air,limit=1] align xyz run setblock ~ ~ ~ minecraft:chest[facing=east]{CustomName:"{\"translate\":\"item.cpp.trade_machine\"}"}
