...
execute at @e[tag=cpp_front_air,limit=1] align xyz run summon minecraft:armor_stand ~0.5 ~ ~0.5 {Invulnerable:1b,Invisible:1b,Small:1b,Marker:1b,NoGravity:1b,DisabledSlots:7967,Tags:["cm_machine","cpp_machine","cpp_golden_anvil"],HandItems:[{},{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{Unbreakable:1b,Damage:24}}],Pose:{LeftArm:[0.0f,0.0f,0.0f]}}
execute at @e[tag=cpp_front_air,limit=1] run setblock ~ ~ ~ minecraft:chest{CustomName:"{\"translate\":\"item.cpp.golden_anvil\"}"}
