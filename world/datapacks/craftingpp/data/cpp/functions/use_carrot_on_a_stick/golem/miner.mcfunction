...
execute at @e[tag=cpp_front_air,limit=1] align xyz positioned ~0.5 ~ ~0.5 run summon minecraft:zombie_pigman ~ ~ ~ {IsBaby:1b,Invulnerable:1b,NoAI:1b,Tags:["cpp_golem","cpp_golem_miner"],DeathLootTable:"cpp:golem/miner",PersistenceRequired:1b,HandItems:[{id:"minecraft:diamond_pickaxe",Count:1b},{}],ArmorDropChances:[-1.0f,-1.0f,-1.0f,-1.0f]}
