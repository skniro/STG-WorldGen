...
function bsd:random
execute as @s[scores={bsdRandom=1..48}] run summon item ~ ~1 ~ {Item:{id:"minecraft:sand",Count:1b}}
execute as @s[scores={bsdRandom=49..68}] run summon item ~ ~1 ~ {Item:{id:"minecraft:gravel",Count:1b}}
